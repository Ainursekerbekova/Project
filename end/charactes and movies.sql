...
('Captain America', 'https://memepedia.ru/wp-content/uploads/2018/05/template-4-768x491.jpg', 'Captain America Comics #1 in march 1941', 'index.php', 'America’s World War II Super-Soldier continues his fight in the present as an Avenger and untiring sentinel of liberty.'),
('Hulk', 'http://sci-fi-news.ru/wp-content/uploads/2018/07/11467362-22fd-4cce-84cf-8327e360393f-hulk-3-850x550.jpg', 'The Incredible Hulk #1 in may 1962', 'index.php', 'Exposed to heavy doses of gamma radiation, scientist Bruce Banner transforms into the mean, green rage machine called the Hulk.\r\n'),
('Iron man', 'http://www.critique-film.fr/wp-content/uploads/2012/07/robert-downey-jr-begins-filming-iron-man-3.jpg', ' Iron Man #1 (May 1968)', 'index.php', 'Inventor Tony Stark applies his genius for high-tech solutions to problems as Iron Man, the armored Avenger\r\nGenius. Billionaire. Playboy. Philanthropist.'),
('Spider-Man', 'https://avatars.mds.yandex.net/get-pdb/1384286/76c06190-204c-4108-a4d4-9e51369cfe34/orig', ' Amazing Fantasy №15 in august 1962 ', 'index.php', 'In the alternate reality of Earth-1610, a young New York City teen was bitten by a genetically enhanced spider. When the Peter Parker of that dimension was killed, the teen—named Miles Morales—was inspired to take up the fallen mantle.');
