   ...
   foreach ($_SESSION["cart_item"] as $item){
	   ...
	   if($total_quantity==3){
		...
		?>
				...
				<td <td style="text-align:center;"><a href="index.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
				$Shipping=$total_quantity*5;
